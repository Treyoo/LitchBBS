...
import com.litchi.bbs.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchService {
    ...
    public void updateDiscuss(DiscussPost discussPost) {
        this.saveDiscuss(discussPost);
    }

    public void deleteDiscussById(int postId) {
        postRepository.deleteById(postId);
    }

    public Page<DiscussPost> searchDiscuss(String keyword, int page, int size) {
